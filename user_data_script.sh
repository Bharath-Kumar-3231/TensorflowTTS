...
if [ $VOLUME_ID ]; then
		...
		sudo -H -u ubuntu bash -c "source /home/ubuntu/anaconda3/bin/activate tensorflow2_latest_p37;pip install .; ./train_resumable.sh task-0" >>/home/ubuntu/logs.txt 2>&1
fi
