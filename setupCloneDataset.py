...
if __name__ == '__main__':
  # Instantiate the parser
    ...
    parser.add_argument('--libri_path', type=str, help='Folder to dump speaker folders')
    parser.add_argument('--dataset_path', type=str, help='Path to core speaker folders')
    ...
    for i in task['speakerIds']:
        ...
        s3.Bucket('murf-models-dev').download_file("dataset/speakers/"+str(i)+".tar", tarPath)
